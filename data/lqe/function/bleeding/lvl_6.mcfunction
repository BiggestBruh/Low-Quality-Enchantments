...
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=0}] lqe.bleeding.6 160
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=1}] lqe.bleeding.6 140
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=2}] lqe.bleeding.6 120
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=3}] lqe.bleeding.6 100
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=4..}] lqe.bleeding.6 80