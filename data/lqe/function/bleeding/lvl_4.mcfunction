...
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=0}] lqe.bleeding.4 160
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=1}] lqe.bleeding.4 140
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=2}] lqe.bleeding.4 120
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=3}] lqe.bleeding.4 100
scoreboard players set @s[type=!#lqe:immune_to_bleeding,scores={lqe.bleeding.armor=4..}] lqe.bleeding.4 80