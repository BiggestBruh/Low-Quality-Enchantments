...
$summon armor_stand $(x) $(y) $(z) {ShowArms:1b,Invisible:1b,Marker:1b,NoGravity:1b,equipment:{chest:{id:leather_chestplate,components:{enchantments:{"lqe:volatile_helper":1}}}}}