...
execute as @e[type=marker,tag=lqe.excavator] at @s if block ~ ~ ~ #lqe:excavation/empty run function lqe:excavation/break/hoe

# If marker is yet to be killed, recheck for an empty block in a little
execute if entity @e[type=marker,tag=lqe.excavator] run schedule function lqe:excavation/air_check/hoe 2t append