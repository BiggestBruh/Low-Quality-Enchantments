...
execute if block ~ ~ ~ minecraft:oak_log run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
execute if block ~ ~ ~ minecraft:oak_log run setblock ~ ~ ~ minecraft:air

# Execute this function recursively for every adjacent block
execute positioned ~ ~ ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~ ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:oak_log run function lqe:timber/oak
