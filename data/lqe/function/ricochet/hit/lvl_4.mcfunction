...
# If exceeded 9 bounces, stop the enchantment's effect
execute if score @s lqe.ricochet.bounces matches 10.. run return fail
...
schedule function lqe:ricochet/delay/lvl_4 1t append