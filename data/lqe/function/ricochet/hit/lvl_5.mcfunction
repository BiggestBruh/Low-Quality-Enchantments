...
# If exceeded 11 bounces, stop the enchantment's effect
execute if score @s lqe.ricochet.bounces matches 12.. run return fail
...
schedule function lqe:ricochet/delay/lvl_5 1t append