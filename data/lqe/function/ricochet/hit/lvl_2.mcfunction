...
# If exceeded 5 bounces, stop the enchantment's effect
execute if score @s lqe.ricochet.bounces matches 6.. run return fail
...
schedule function lqe:ricochet/delay/lvl_2 1t append