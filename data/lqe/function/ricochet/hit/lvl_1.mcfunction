...
# If exceeded 3 bounces, stop the enchantment's effect
execute if score @s lqe.ricochet.bounces matches 4.. run return fail
...
schedule function lqe:ricochet/delay/lvl_1 1t append