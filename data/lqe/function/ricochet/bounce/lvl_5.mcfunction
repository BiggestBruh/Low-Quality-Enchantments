...
execute unless block ~1 ~ ~ #minecraft:replaceable store result entity @s Motion[0] double -0.007 run scoreboard players get @s lqe.ricochet.dx
execute unless block ~-1 ~ ~ #minecraft:replaceable store result entity @s Motion[0] double -0.007 run scoreboard players get @s lqe.ricochet.dx
execute unless block ~ ~1 ~ #minecraft:replaceable store result entity @s Motion[1] double -0.007 run scoreboard players get @s lqe.ricochet.dy
execute unless block ~ ~-1 ~ #minecraft:replaceable store result entity @s Motion[1] double -0.007 run scoreboard players get @s lqe.ricochet.dy
execute unless block ~ ~ ~1 #minecraft:replaceable store result entity @s Motion[2] double -0.007 run scoreboard players get @s lqe.ricochet.dz
execute unless block ~ ~ ~-1 #minecraft:replaceable store result entity @s Motion[2] double -0.007 run scoreboard players get @s lqe.ricochet.dz
