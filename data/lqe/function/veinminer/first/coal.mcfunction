...
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:coal_ore run function lqe:veinminer/coal
