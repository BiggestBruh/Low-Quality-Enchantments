...
execute if block ~ ~ ~ minecraft:nether_gold_ore run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
execute if block ~ ~ ~ minecraft:nether_gold_ore run setblock ~ ~ ~ minecraft:air
# Spawn experience orbs
scoreboard players set @s lqe.veinminer.xp_roll 0
execute if predicate lqe:extraction/0 store result score @s lqe.veinminer.xp_roll run random value 0..1
execute if predicate lqe:extraction/1 store result score @s lqe.veinminer.xp_roll run random value 0..1
execute if predicate lqe:extraction/2 store result score @s lqe.veinminer.xp_roll run random value 0..2
execute if predicate lqe:extraction/3 store result score @s lqe.veinminer.xp_roll run random value 0..2
execute if predicate lqe:extraction/4 store result score @s lqe.veinminer.xp_roll run random value 0..2
execute if predicate lqe:extraction/5 store result score @s lqe.veinminer.xp_roll run random value 0..2
...
execute positioned ~ ~ ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~ ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function lqe:veinminer/nether_gold
