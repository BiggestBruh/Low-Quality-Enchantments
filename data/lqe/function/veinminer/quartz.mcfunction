...
execute if block ~ ~ ~ minecraft:nether_quartz_ore run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
execute if block ~ ~ ~ minecraft:nether_quartz_ore run setblock ~ ~ ~ minecraft:air
...
execute positioned ~ ~ ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~ ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:nether_quartz_ore run function lqe:veinminer/quartz
