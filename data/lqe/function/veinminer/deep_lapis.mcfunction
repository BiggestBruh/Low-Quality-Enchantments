...
execute if block ~ ~ ~ minecraft:deepslate_lapis_ore run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
execute if block ~ ~ ~ minecraft:deepslate_lapis_ore run setblock ~ ~ ~ minecraft:air
# Spawn experience orbs
scoreboard players set @s lqe.veinminer.xp_roll 0
execute if predicate lqe:extraction/0 store result score @s lqe.veinminer.xp_roll run random value 2..5
execute if predicate lqe:extraction/1 store result score @s lqe.veinminer.xp_roll run random value 3..6
execute if predicate lqe:extraction/2 store result score @s lqe.veinminer.xp_roll run random value 3..8
execute if predicate lqe:extraction/3 store result score @s lqe.veinminer.xp_roll run random value 4..9
execute if predicate lqe:extraction/4 store result score @s lqe.veinminer.xp_roll run random value 4..10
execute if predicate lqe:extraction/5 store result score @s lqe.veinminer.xp_roll run random value 5..11
...
execute positioned ~ ~ ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~ ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:deepslate_lapis_ore run function lqe:veinminer/deep_lapis
