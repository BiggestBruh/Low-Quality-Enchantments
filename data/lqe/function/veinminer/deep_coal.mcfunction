...
execute if block ~ ~ ~ minecraft:deepslate_coal_ore run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
execute if block ~ ~ ~ minecraft:deepslate_coal_ore run setblock ~ ~ ~ minecraft:air

# Execute this function recursively for every adjacent block
execute positioned ~ ~ ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~ ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~-1 ~ ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~ ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
...
execute positioned ~1 ~-1 ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ minecraft:deepslate_coal_ore run function lqe:veinminer/deep_coal
